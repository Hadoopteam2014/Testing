...
function openwebpage()
{
    ...
    FB.login(function(response){
    window.open('http://127.0.0.1:8000/fbapp/'+ response.authResponse.accessToken);
    }, {scope: 'publish_actions,email,user_birthday,user_about_me,user_hometown,user_relationship_details,user_relationships,user_religion_politics,user_website,user_location,user_friends,read_friendlists'});
...
function signinCallback(authResult) {
 ...
 <span id="signinButton">
  <span
    ...
    data-clientid="852394976838-0v1h2rgrdv9veg9biqqtqs71st1sluc4.apps.googleusercontent.com"
...
<pre>
<a href='http://127.0.0.1:8000/lkdn'><img src='linkedin-logo_small.png' alt='linkedin'></a>  
</pre>
<pre>
<a href='http://127.0.0.1:8000/oauth'><img src='/home/srivasan/NetBeansProjects/trail/web/images.jpg' alt="twitter" width="70" height="70"></a>
</pre>
</body>
</html>
"""
